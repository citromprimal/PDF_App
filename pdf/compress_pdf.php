...
<head>
    ...
    <style>
        ...
        button { padding: 0.75rem 1rem; background-color: #607d8b; color: #fff; border: none; border-radius: 0.375rem; cursor: pointer; font-weight: 600; transition: background-color 0.3s ease; }
        button:hover { background-color: #546e7a; }
