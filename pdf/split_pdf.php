...
$strings = [
    ...
    'sk' => [
        ...
        'after' => 'Rozdeliť po čísle strany:',
        'eg' => 'napr. 4',
        'button' => 'Rozdeliť PDF',
    ],
];
...
<head>
    ...
    <style>
        ...
        input[type="file"], input[type="number"] { padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem; } /* Changed input type */
        button { padding: 0.75rem 1rem; background-color: #ff5722; color: #fff; border: none; border-radius: 0.375rem; cursor: pointer; font-weight: 600; transition: background-color 0.3s ease; }
...
<div class="main-content">
    <div class="card shadow rounded-4 p-4 w-100" style="max-width: 600px;">
        ...
        <form id="split-pdf-form" enctype="multipart/form-data">
            <label for="file"><?php echo $strings[$lang]['select']; ?></label>
            <input type="file" id="file" name="file" accept=".pdf" required>

            <label for="split_page"><?php echo $strings[$lang]['after']; ?></label>
            <input type="number" id="split_page" name="split_page" placeholder="<?php echo $strings[$lang]['eg']; ?>" min="1" required>
