...
$strings = [
    ...
    'sk' => [
        ...
        'header' => 'Previesť PDF na Text',
        'select' => 'Vyberte súbor PDF:',
        'button' => 'Previesť na Text',
    ],
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        button { padding: 0.75rem 1rem; background-color: #6c757d; color: #fff; border: none; border-radius: 0.375rem; cursor: pointer; font-weight: 600; transition: background-color 0.3s ease; }
        button:hover { background-color: #5a6268; }
        #message { margin-top: 1rem; padding: 0.75rem; border-radius: 0.375rem; text-align: center; font-weight: 600; white-space: pre-wrap; overflow-wrap: break-word; } /* Added for text output */
