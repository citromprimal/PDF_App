...
$strings = [
    'en' => [
        ...
        'header' => 'Reorder PDF Pages',
        'select' => 'Select a PDF file:',
        'pgs_to_reorder' => 'Desired page order (e.g., 3,1,2,4):',
        'eg'=>'e.g., 3,1,2,4',
    ...
    'sk' => [
        ...
        'header' => 'Zmeniť poradie strán PDF',
        'select' => 'Vyberte súbor PDF:',
        'pgs_to_reorder' => 'Požadované poradie strán (napr. 3,1,2,4):',
        'eg'=>'napr. 3,1,2,4',
        'button' => 'Zmeniť poradie strán',
    ],
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        button { padding: 0.75rem 1rem; background-color: #ffc107; color: #212529; border: none; border-radius: 0.375rem; cursor: pointer; font-weight: 600; transition: background-color 0.3s ease; }
...
<div class="main-content">
    <div class="card shadow rounded-4 p-4 w-100" style="max-width: 600px;">
        ...
        <form id="reorder-pages-form" enctype="multipart/form-data">
            <label for="file"><?php echo $strings[$lang]['select']; ?></label>
            <input type="file" id="file" name="file" accept=".pdf" required>

            <label for="order"><?php echo $strings[$lang]['pgs_to_reorder']; ?></label>
            <input type="text" id="order" name="order" placeholder="<?php echo $strings[$lang]['eg']; ?>" required>
