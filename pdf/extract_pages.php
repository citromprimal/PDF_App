...
$strings = [
    'en' => [
        ...
        'pgs_to_extract' => 'Pages to extract (e.g., 1, 3, 5-7):',
        'eg'=>'e.g., 1, 3, 5-7',
    ...
    'sk' => [
        ...
        'header' => 'Extrahovať Strany PDF',
        'select' => 'Vyberte súbor PDF:',
        'pgs_to_extract' => 'Strany na extrahovanie (napr. 1, 3, 5-7):',
        'eg'=>'napr. 1, 3, 5-7',
        'button' => 'Extrahovať Strany',
    ],
];
...
<head>
    ...
    <style>
        ...
        button { padding: 0.75rem 1rem; background-color: #17a2b8; color: #fff; border: none; border-radius: 0.375rem; cursor: pointer; font-weight: 600; transition: background-color 0.3s ease; }
...
<div class="main-content">
    <div class="card shadow rounded-4 p-4 w-100" style="max-width: 600px;">
        ...
        <form id="extract-pages-form" enctype="multipart/form-data">
            <label for="file"><?php echo $strings[$lang]['select']; ?></label>
            <input type="file" id="file" name="file" accept=".pdf" required>

            <label for="pages"><?php echo $strings[$lang]['pgs_to_extract']; ?></label>
