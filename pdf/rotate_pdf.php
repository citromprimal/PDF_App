...
<head>
    ...
    <style>
        ...
        input[type="file"], select { padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem; }
        button { padding: 0.75rem 1rem; background-color: #007bff; color: #fff; border: none; border-radius: 0.375rem; cursor: pointer; font-weight: 600; transition: background-color 0.3s ease; }
...
<div class="main-content">
    <div class="card shadow rounded-4 p-4 w-100" style="max-width: 600px;">
        ...
        <form id="rotate-pages-form" enctype="multipart/form-data">
            <label for="file"><?php echo $strings[$lang]['select']; ?></label>
            <input type="file" id="file" name="file" accept=".pdf" required>

            <label for="rotation"><?php echo $strings[$lang]['angle']; ?></label>
