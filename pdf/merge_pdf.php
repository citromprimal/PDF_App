...
$strings = [
    ...
    'sk' => [
        ...
        'header' => 'Zlúčiť súbory PDF',
        'select' => 'Vyberte súbory PDF na zlúčenie:',
        'button' => 'Zlúčiť súbory PDF',
    ],
];
?>
<!DOCTYPE html>
...
<div class="main-content">
    <div class="card shadow rounded-4 p-4 w-100" style="max-width: 600px;">
        ...
        <form id="merge-form" enctype="multipart/form-data">
            <label for="files"><?php echo $strings[$lang]['select']; ?></label>
