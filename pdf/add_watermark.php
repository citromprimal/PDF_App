...
$strings = [
    'en' => [
        ...
        'header' => 'Add Text Watermark',
        'select' => 'Select a PDF file:',
        'wm_txt' => 'Watermark Text:',
        'e_wm_txt' => 'Enter watermark text',
    ...
    'sk' => [
        ...
        'header' => 'Pridať Textovú Vodotlač',
        'select' => 'Vyberte súbor PDF:',
        'wm_txt' => 'Text Vodoznaku:',
        'e_wm_txt' => 'Zadajte text vodoznaku',
        'button' => 'Pridať Vodoznak',
...
<div class="main-content">
    <div class="card shadow rounded-4 p-4 w-100" style="max-width: 600px;">
        ...
        <form id="add-watermark-form" enctype="multipart/form-data">
            ...
            <label for="text"><?php echo $strings[$lang]['wm_txt']; ?></label>
            <input type="text" id="text" name="text" placeholder="<?php echo $strings[$lang]['e_wm_txt']; ?>" required>
