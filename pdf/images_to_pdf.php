...
$strings = [
    'en' => [
        ...
        'header' => 'Convert Images to PDF',
        'select' => 'Select images to convert (PNG, JPG):',
    ...
    'sk' => [
        ...
        'header' => 'Previesť obrázky do PDF',
        'select' => 'Vyberte obrázky na konverziu (PNG, JPG):',
        'button' => 'Previesť do PDF',
    ],
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        input[type="file"] { padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem; }
        button { padding: 0.75rem 1rem; background-color: #28a745; color: #fff; border: none; border-radius: 0.375rem; cursor: pointer; font-weight: 600; transition: background-color 0.3s ease; }
...
<div class="main-content">
    <div class="card shadow rounded-4 p-4 w-100" style="max-width: 600px;">
        ...
        <form id="images-to-pdf-form" enctype="multipart/form-data">
            <label for="images"><?php echo $strings[$lang]['select']; ?></label>
            <input type="file" id="images" name="images[]" multiple accept=".png, .jpg, .jpeg" required>
